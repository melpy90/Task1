module.exports = {
    ...
    "Purchase an item missing the surname": function(browser) {
        ...
        browser
            ...
            .setValue("#last-name", "")
            .setValue("#postal-code", "00001")
            .assert.visible("#continue")
            .click("#continue")
            .assert.textContains(".error-message-container > h3:nth-child(1)", "Error: Last Name is required")
